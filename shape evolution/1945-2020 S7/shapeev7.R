...
mu=data.frame(date, Ufh, Ufb, Usb, Ush, H, D, B, F)
...
s7=mu; s7$ns[Ufh==1]=0.25;s7$ns[Ufb==1]=0.5; s7$ns[Usb==1]=0.75; s7$ns[Ush==1]=1
...
ggplot(s7,aes(date,ns)) + geom_point(aes(col=ms), size=1, show.legend=T) + 
